...
export const METRICS: Record<MetricKey, MetricDef> = {
  active_calories: { key: "active_calories", field: "active_calories", label: "Active Calories", unit: "kcal", icon: "flame", format: intFmt },
  total_calories: { key: "total_calories", field: "total_calories", label: "Total Calories", unit: "kcal", icon: "flame", format: intFmt },
  avg_heart_rate: { key: "avg_heart_rate", field: "avg_heart_rate", label: "Avg Heart Rate", unit: "bpm", icon: "heart", format: intFmt },
  max_heart_rate: { key: "max_heart_rate", field: "max_heart_rate", label: "Max Heart Rate", unit: "bpm", icon: "heart-pulse", format: intFmt },
  resting_hr: { key: "resting_hr", field: "resting_hr", label: "Resting HR", unit: "bpm", icon: "heart", format: intFmt },
  hrv: { key: "hrv", field: "hrv_avg", label: "HRV", unit: "ms", icon: "activity", format: intFmt },
  spo2: { key: "spo2", field: "spo2_avg", label: "SpO₂", unit: "%", icon: "droplet", format: oneDp },
  sleep_score: { key: "sleep_score", field: "sleep_score", label: "Sleep Score", unit: "", icon: "moon", format: scoreFmt },
  readiness: { key: "readiness", field: "readiness_score", label: "Readiness", unit: "", icon: "battery-charging", format: scoreFmt },
  activity: { key: "activity", field: "activity_score", label: "Activity", unit: "", icon: "footprints", format: scoreFmt },
  steps: { key: "steps", field: "total_steps", label: "Steps", unit: "", icon: "footprints", format: intFmt },
  training_load: { key: "training_load", field: "training_load", label: "Training Load", unit: "", icon: "dumbbell", format: intFmt },
  distance: { key: "distance", field: "total_distance_km", label: "Distance", unit: "km", icon: "map", format: oneDp },
  stress: { key: "stress", field: "stress_avg", label: "Stress", unit: "", icon: "gauge", format: scoreFmt },
  body_battery: { key: "body_battery", field: "body_battery_max", label: "Body Battery", unit: "", icon: "battery-charging", format: scoreFmt },
  vo2_max: { key: "vo2_max", field: "vo2_max", label: "VO₂ Max", unit: "", icon: "activity", format: oneDp },
};
...
export function readMetric(def: MetricDef, row: WearableMetricRow | null | undefined): string | null {
