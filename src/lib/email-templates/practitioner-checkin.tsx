  ...
  return (
    <EmailShell preview={`${from} is checking in with you on Buddy.`}>
      ...
      <Text style={styles.text}>
        ...
        {from.toLowerCase() === "your practitioner" ? "your practitioner" : from} would like to
        check in with you given your recent symptoms.
      </Text>
      <Text style={styles.text}>
        Please open Buddy and log how you&apos;re feeling today — it only takes a minute and helps
        {practitionerName ? ` ${practitionerName}` : " your practitioner"} support you between
        sessions.
      </Text>
