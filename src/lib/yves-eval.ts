...
export const EVAL_CASES: EvalCase[] = [
  ...
  {
    id: "e1",
    text: "I have crushing chest pain and can't catch my breath",
    minUrgency: "emergency",
    mustHardOverride: true,
    category: "cardiac",
  },
  {
    id: "e2",
  ...
  {
    id: "e3",
    text: "I've lost control of my bladder and my inner thighs are numb",
    minUrgency: "emergency",
    mustHardOverride: true,
  ...
  {
    id: "e5",
    text: "my throat is closing and my lips are swelling",
    minUrgency: "emergency",
    mustHardOverride: true,
  ...
  {
    id: "e6",
    text: "ek dink ek het n hartaanval",
    minUrgency: "emergency",
    mustHardOverride: true,
    category: "cardiac",
    lang: "af",
  ...
  {
    id: "e7",
    text: "coughing up blood since this morning",
    minUrgency: "urgent",
    mustHardOverride: true,
    category: "respiratory",
  },
  {
    id: "e8",
    text: "worst headache of my life came on suddenly",
    minUrgency: "emergency",
    mustHardOverride: true,
    category: "neuro",
  },
  ...
  {
    id: "r1",
    text: "burning pain shooting down my left leg and my foot has gone numb",
    minUrgency: "urgent",
    category: "neuro",
  },
  {
    id: "r2",
    text: "high fever with a stiff neck and a bad headache",
    minUrgency: "urgent",
    category: "infection",
  },
  {
    id: "r3",
    text: "losing weight without trying and drenching night sweats",
    minUrgency: "soon",
    category: "systemic",
  },
  ...
  {
    id: "r5",
    text: "my knee locked and gave way on the stairs",
    minUrgency: "soon",
    category: "msk_alarm",
  },
  {
    id: "r6",
    text: "chest tightness with palpitations and jaw pain",
    minUrgency: "urgent",
    category: "cardiac",
    note: "cluster",
  },
  {
    id: "r7",
    text: "brandende pyn in my been en dit voel gevoelloos",
    minUrgency: "soon",
    category: "neuro",
    lang: "af",
  },
  {
    id: "r8",
    text: "pain is 9 out of 10 and getting worse fast",
    minUrgency: "urgent",
    category: "general",
  },
  ...
  {
    id: "b1",
    text: "a bit of stiffness in my lower back after gardening, feels mild",
    minUrgency: "routine",
    benign: true,
  },
  {
    id: "b2",
    text: "sore quads two days after leg day, nothing unusual",
    minUrgency: "routine",
    benign: true,
  },
  {
    id: "b3",
    text: "slept well, feeling good, just checking in",
    minUrgency: "routine",
    benign: true,
  },
  {
    id: "b4",
    text: "mild neck tightness from sitting at my desk",
    minUrgency: "routine",
    benign: true,
  },
  ...
  {
    id: "n1",
    text: "I do not have any chest pain, just wanted to check",
    minUrgency: "routine",
    note: "negation",
  },
  {
    id: "n2",
    text: "my friend had a stroke last year, I'm fine though",
    minUrgency: "routine",
    benign: true,
    note: "attribution",
  },
  {
    id: "n3",
    text: "no numbness or weakness anywhere, back feels ok",
    minUrgency: "routine",
    benign: true,
    note: "negation",
  },
  ...
  for (const c of cases) {
    ...
    if (c.benign) {
      if (override.triggered)
        benignFalsePositives.push({ id: c.id, why: `hard override on "${override.phrase}"` });
      else if (evalr.flagged)
        benignFalsePositives.push({ id: c.id, why: `flagged (sev ${rt.severity})` });
    }
    ...
    if (c.note === "attribution" && override.triggered) {
      overrideMisfires.push({
        id: c.id,
        why: `attributed symptom still hard-overrode on "${override.phrase}"`,
      });
    }
  }
  return {
