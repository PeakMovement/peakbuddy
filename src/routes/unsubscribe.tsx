    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-6">
      <div className="max-w-md w-full bg-card border border-border rounded-2xl p-8 shadow-sm">
        ...
        <p className="text-muted-foreground">
          To stop receiving Buddy emails, use the unsubscribe link at the bottom of any Buddy email.
          It opens a confirmation page and takes effect right away.
        </p>
        <p className="text-muted-foreground mt-4">
          Sign-in and password-reset emails always keep working so you can still access your
          account.
        </p>
      </div>
    </div>
