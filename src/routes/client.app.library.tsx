  ...
  return (
    <div style={wrap}>
      <header style={{ marginBottom: 4 }}>
        ...
        <p style={sub}>
          Curated programs from your Peak Movement team. We add new ones every week — check back
          often.
        </p>
      </header>
      ...
      {status === "error" && (
        <p style={muted}>
          We couldn't load the library just now. Please pull to refresh or try again shortly.
        </p>
      )}
      ...
      {status === "ready" && programs && programs.length === 0 && (
        <div style={emptyBox}>
          ...
          <p style={{ ...muted, margin: 0 }}>
            New programs are on their way. We're building your library now — you'll get a nudge when
            the first ones land.
          </p>
        </div>
      )}
...
function LibraryIntro({ onClose }: { onClose: () => void }) {
  return (
    <div
      role="dialog"
      aria-modal="true"
      aria-label="Welcome to your Exercise Library"
      style={overlay}
    >
      <div style={modal}>
        ...
        <p style={introBody}>
          This is a growing collection of guided programs, hand-picked by your Peak Movement team.
          Each one shows its goal and who it's best suited to, so you can find what fits how you're
          feeling.
        </p>
        <p style={introBody}>
          We add fresh programs <strong style={{ color: "var(--white)" }}>every week</strong>, and
          Buddy will point you toward the ones most relevant to you. Tap any program to open it and
          get started.
        </p>
